...
function update() {
    ...
    if ($('#city').parent().hasClass('has-error') ||
        ...
        $('#phno').parent().hasClass('has-error') ||
        ...
        $("#lastname").val().trim().length == 0 || $("#city").val().trim().length == 0 || $("#states").val() == "Select one") {
        $('#updateProfileError').text("Please Enter Mandatory Fields");
