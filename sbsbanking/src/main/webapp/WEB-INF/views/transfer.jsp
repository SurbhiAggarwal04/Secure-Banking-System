            ...
            <sec:authorize access="hasRole('ROLE_USER')">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/transferConfirmation" method="post" id="TransferForm">
                            Select the Account:&nbsp;&nbsp;&nbsp;
                            <select name="fromAccount" class="form-control">
                                <c:forEach var="accountNumber" items="${accounts}">
                                    <option value="${accountNumber}">${accountNumber}</option>
                                </c:forEach>
                            </select>
                            Recipient Account Number: &nbsp;&nbsp;&nbsp;<input type="text" name="toAccount"/><br/>
