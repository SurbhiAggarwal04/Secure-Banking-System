        ...
        <article class="col-xs-12 maincontent">
            ...
            <sec:authorize access="hasRole('ROLE_USER')">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <h4>From Account Number:{$fromAccountNumber}</h4>
                        <h4>To Account Number:{$toAccountNumber}</h4>
                        <h4>Amount:{$amount}</h4>
                        <h4>Date:{date}</h4>

                        <h1>Thank you, your transaction will be processed and you will be updated soon.</h1>
                    </div>
                </div>
            </sec:authorize>
        </article>
